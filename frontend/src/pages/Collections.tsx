  ...
  return (
    <div className="bg-background text-on-surface min-h-screen">
      ...
      <main className="pt-24 pb-32 md:pb-16 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        {/* Hero Section */}
        <section className="mb-20 text-center md:text-left mt-8">
          <h2 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-primary mb-4">
            The Archive of Form
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-8 group cursor-pointer">
            <Link to="/gallery">
              <div className="relative overflow-hidden aspect-[16/9] mb-6 rounded-lg soft-shadow">
                <img 
                  alt="Summer Solstice" 
          ...
          {/* Small Card 1 */}
          <div className="lg:col-span-4 group cursor-pointer mt-0 lg:mt-24">
            <Link to="/gallery">
              <div className="relative overflow-hidden aspect-[3/4] mb-6 rounded-lg soft-shadow">
                <img 
                  alt="Urban Weave" 
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" 
          ...
          <div className="lg:col-span-5 group cursor-pointer">
            <Link to="/gallery">
              <div className="relative overflow-hidden aspect-[4/5] mb-6 rounded-lg soft-shadow">
                <img 
          ...
          {/* Medium Card */}
          <div className="lg:col-span-7 group cursor-pointer lg:-mt-12">
            <Link to="/gallery">
              <div className="relative overflow-hidden aspect-[4/3] mb-6 rounded-lg soft-shadow">
                <img 
                  alt="Nordic Knot" 
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" 
        ...
        {/* Designer Note Section (Bento style) */}
        <section className="mt-32 p-12 bg-surface-container-low rounded-lg flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            ...
            <h2 className="font-headline-lg text-headline-lg text-on-surface mb-6">
              "Patience is the invisible thread that binds every garment we create."
            </h2>
            <Link to="/about">
          ...
          <div className="md:w-1/2 aspect-video rounded-lg overflow-hidden soft-shadow">
            <img 
              alt="The Process" 
